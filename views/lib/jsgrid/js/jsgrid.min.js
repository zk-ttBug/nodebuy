...
function(a, b, c) {
    ...
    d.prototype = {
        ...
        _initController: function() {
            this._controller = b.extend({},
            u, t(this.controller, this))
        },
        ...
        _createHeaderRow: function() {
            if (b.isFunction(this.headerRowRenderer)) return b(this.headerRowRenderer());
            var a = b("<tr>").addClass(this.headerRowClass);
            return this._eachField(function(c, d) {
                var e = b("<th>").addClass(c.headercss || c.css).appendTo(a).append(c.headerTemplate ? c.headerTemplate() : "").css("width", c.width);
        ...
        _createFilterRow: function() {
            if (b.isFunction(this.filterRowRenderer)) return b(this.filterRowRenderer());
            var a = b("<tr>").addClass(this.filterRowClass);
            return this._eachField(function(c) {
                b("<td>").addClass(c.filtercss || c.css).appendTo(a).append(c.filterTemplate ? c.filterTemplate() : "").width(c.width)
            }),
            a
        },
        _createInsertRow: function() {
            if (b.isFunction(this.insertRowRenderer)) return b(this.insertRowRenderer());
            var a = b("<tr>").addClass(this.insertRowClass);
            return this._eachField(function(c) {
                b("<td>").addClass(c.insertcss || c.css).appendTo(a).append(c.insertTemplate ? c.insertTemplate() : "").width(c.width)
            }),
            a
        },
        ...
        _refreshContent: function() {
            var a = this._content;
            if (a.empty(), !this.data.length) return a.append(this._createNoDataRow()),
            this;
        ...
        _createNoDataRow: function() {
            var a = t(this.noDataContent, this);
            return b("<tr>").addClass(this.noDataRowClass).append(b("<td>").attr("colspan", this.fields.length).append(a))
        },
        _createNoDataContent: function() {
            return b.isFunction(this.noDataRenderer) ? this.noDataRenderer() : this.noDataText
        },
        _createRow: function(a, c) {
            var d;
            return b.isFunction(this.rowRenderer) ? d = b(this.rowRenderer(a, c)) : (d = b("<tr>"), this._renderCells(d, a)),
            d.addClass(this._getRowClasses(a, c)).data(g, a).on("click", b.proxy(function(b) {
                this.rowClick({
                    item: a,
                    itemIndex: c,
                    event: b
        ...
        _getRowClasses: function(a, b) {
            var c = [];
            return c.push((b + 1) % 2 ? this.oddRowClass: this.evenRowClass),
        ...
        _createCell: function(a, c) {
            var d, e = a[c.name];
            return d = b.isFunction(c.cellRenderer) ? b(c.cellRenderer(e, a)) : b("<td>").append(c.itemTemplate ? c.itemTemplate(e, a) : e),
            d.addClass(c.css).width(c.width),
            c.align && d.addClass("jsgrid-align-" + c.align),
            d
        },
        sort: function(a, c) {
            return b.isPlainObject(a) && (c = a.order, a = a.field),
            this._clearSortingCss(),
        ...
        _setSortingParams: function(a, b) {
            a = this._normalizeSortingField(a),
            b = b || (this._sortField === a ? this._reversedSortOrder(this._sortOrder) : i),
            this._sortField = a,
            this._sortOrder = b
        },
        _normalizeSortingField: function(a) {
            return b.isNumeric(a) ? this.fields[a] : "string" == typeof a ? b.grep(this.fields,
            function(b) {
                return b.name === a
            })[0] : a
        },
        ...
        _setSortingCss: function() {
            var a = b.inArray(this._sortField, this.fields);
        ...
        _refreshPager: function() {
            ...
            a.empty(),
            this.paging && a.append(this._createPager());
        ...
        _createPagerByFormat: function() {
            ...
            return b.map(e, b.proxy(function(e) {
                var f = e;
                return e === l ? f = this._createPages() : e === k ? f = this._createPagerNavButton(this.pageFirstText, 1, a > 1) : e === m ? f = this._createPagerNavButton(this.pagePrevText, a - 1, a > 1) : e === n ? f = this._createPagerNavButton(this.pageNextText, a + 1, c > a) : e === o ? f = this._createPagerNavButton(this.pageLastText, c, c > a) : e === p ? f = a: e === q ? f = c: e === r && (f = d),
                b.isArray(f) ? f.concat([" "]) : [f, " "]
            },
            this))
        },
        _createPages: function() {
            var a, b = this._pagesCount(),
            c = this.pageButtonCount,
            d = this._firstDisplayingPage,
            e = [];
            d > 1 && e.push(this._createPagerPageNavButton(this.pageNavigatorPrevText, this.showPrevPages));
            for (var f = 0,
            a = d; c > f && b >= a; f++, a++) e.push(a === this.pageIndex ? this._createPagerCurrentPage() : this._createPagerPage(a));
            return b > d + c - 1 && e.push(this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNextPages)),
            e
        },
        _createPagerNavButton: function(a, c, d) {
            return this._createPagerButton(a, this.pagerNavButtonClass + (d ? "": " " + this.pagerNavButtonInactiveClass), d ?
            function() {
                this.openPage(c)
            }: b.noop)
        },
        ...
        _createPagerPage: function(a) {
            return this._createPagerButton(a, this.pageClass,
            function() {
                this.openPage(a)
            })
        },
        ...
        _refreshWidth: function() {
            ...
            b = this._bodyGrid,
            c = this.width;
            "auto" === c && (a.width("auto"), c = a.outerWidth()),
            a.width(""),
            b.width(""),
            this._container.width(c),
            c = a.outerWidth(),
            b.width(c)
        },
        ...
        _refreshHeight: function() {
            ...
            d = this.height;
            b.height(d),
            "auto" !== d && (d = b.height(), a = this._header.outerHeight(!0), c.parents(b).length && (a += c.outerHeight(!0)), this._body.outerHeight(d - a))
        },
        showPrevPages: function() {
            var a = this._firstDisplayingPage,
            b = this.pageButtonCount;
            this._firstDisplayingPage = a > b ? a - b: 1,
            this._refreshPager()
        },
        ...
        _controllerCall: function(a, c, d, e) {
            ...
            if (!f || !f[a]) throw new Error("controller has no method '" + a + "'");
            return b.when(f[a](c)).done(b.proxy(e, this)).fail(b.proxy(this._errorHandler, this)).always(b.proxy(this._hideLoading, this))
        },
        ...
        loadData: function(a) {
            ...
            return this._controllerCall("loadData", a, c.cancel,
            function(a) {
        ...
        getFilter: function() {
            ...
            return this._eachField(function(b) {
                b.filtering && (a[b.name] = b.filterValue())
            }),
            a
        },
        ...
        clearFilter: function() {
            ...
            return this._filterRow.replaceWith(a),
            this._filterRow = a,
            this.search()
        },
        insertItem: function(a) {
            var b = a || this._getInsertItem(),
            c = this._callEventHandler(this.onItemInserting, {
                item: b
            });
            return this._controllerCall("insertItem", b, c.cancel,
            function(a) {
                a = a || b,
        ...
        _getInsertItem: function() {
            var a = {};
            return this._eachField(function(b) {
                b.inserting && (a[b.name] = b.insertValue())
            }),
            a
        },
        clearInsert: function() {
            var a = this._createInsertRow();
            this._insertRow.replaceWith(a),
            this._insertRow = a,
            this.refresh()
        },
        editItem: function(a) {
            var b = this._rowByItem(a);
            b.length && this._editRow(b)
        },
        _rowByItem: function(a) {
        ...
        _createEditRow: function(a) {
            if (b.isFunction(this.editRowRenderer)) return b(this.editRowRenderer(a, this._itemIndex(a)));
            var c = b("<tr>").addClass(this.editRowClass);
            return this._eachField(function(d) {
                b("<td>").addClass(d.editcss || d.css).appendTo(c).append(d.editTemplate ? d.editTemplate(a[d.name], a) : "").width(d.width || "auto")
            }),
            c
        },
        updateItem: function(a, b) {
            1 === arguments.length && (b = a);
            var c = a ? this._rowByItem(a) : this._editingRow;
            return b = b || this._getEditedItem(),
            this._updateRow(c, b)
        },
        _updateRow: function(a, c) {
            ...
            return this._controllerCall("updateItem", d, h.cancel,
            function(b) {
                b = b || d;
                var c = this._finishUpdate(a, b, e);
        ...
        _finishUpdate: function(a, b, c) {
            ...
            return a.replaceWith(d),
            d
        },
        _getEditedItem: function() {
            var a = {};
            return this._eachField(function(b) {
                b.editing && (a[b.name] = b.editValue())
            }),
            a
        },
        cancelEdit: function() {
            if (this._editingRow) {
                var a = this._editingRow,
                b = a.data(h);
                b.remove(),
                a.show(),
                this._editingRow = null
        ...
        _deleteRow: function(a) {
            ...
            return this._controllerCall("deleteItem", b, d.cancel,
            function() {
    ...
    b.fn.jsGrid = function(a) {
        ...
        return this.each(function() {
            ...
            if (j) if ("string" == typeof a) {
                if (e = j[a].apply(j, g), e !== c && e !== j) return h = e,
                !1
            } else j._detachWindowResizeCallback(),
            j._init(a),
            j.render();
            else new d(i, a)
        }),
    ...
    w = function(a) {
        var c;
        b.isPlainObject(a) ? c = d.prototype: (c = v[a].prototype, a = arguments[1] || {}),
        b.extend(c, a)
    };
    a.jsGrid = {
        Grid: d,
...
function(a, b) {
    ...
    c.prototype = {
        ...
        finishInsert: function(a) {
            var b = this._grid;
            b.option("data").push(a),
            b.refresh()
        },
        finishDelete: function(a, b) {
            var c = this._grid;
            c.option("data").splice(b, 1),
            c.reset()
        }
    },
    d.prototype = {
        ...
        finishLoad: function(a) {
            this._itemsCount = a.itemsCount,
            this._grid.option("data", a.data)
        },
...
function(a, b) {
    ...
    c.prototype = new d({
        ...
        filterTemplate: function() {
            ...
            return this.autosearch && b.on("keypress",
            function(b) {
        ...
        insertTemplate: function() {
            ...
            var a = this.insertControl = this._createTextBox();
            return a
        },
        editTemplate: function(a) {
            if (!this.editing) return this.itemTemplate(a);
...
function(a, b) {
    ...
    c.prototype = new d({
        ...
        _createTextBox: function() {
            return b("<input>").attr("type", "number")
        }
    }),
    a.fields.number = a.NumberField = c
} (jsGrid, jQuery),
function(a, b) {
    function c(a) {
        d.call(this, a)
    ...
    c.prototype = new d({
        insertTemplate: function() {
            if (!this.inserting) return "";
            var a = this.insertControl = this._createTextArea();
            return a
        },
        editTemplate: function(a) {
            if (!this.editing) return this.itemTemplate(a);
...
function(a, b, c) {
    function d(a) {
        ...
        this.valueField = "",
        this.textField = "",
        a.valueField && a.items.length && (this.valueType = typeof a.items[0][a.valueField]),
    ...
    d.prototype = new e({
        ...
        filterTemplate: function() {
            ...
            return this.autosearch && b.on("change",
            function() {
                a.search()
            }),
            b
        ...
        insertTemplate: function() {
            if (!this.inserting) return "";
            var a = this.insertControl = this._createSelect();
            return a
        },
        editTemplate: function(a) {
            if (!this.editing) return this.itemTemplate(a);
        ...
        filterValue: function() {
            ...
            return "number" === this.valueType ? parseInt(a || 0, 10) : a
        },
        insertValue: function() {
...
function(a, b, c) {
    ...
    d.prototype = new e({
        ...
        insertTemplate: function() {
            if (!this.inserting) return "";
            var a = this.insertControl = this._createCheckbox();
            return a
        },
        editTemplate: function(a) {
            if (!this.editing) return this.itemTemplate(a);
            var b = this.editControl = this._createCheckbox();
            return b.prop("checked", a),
            b
        },
        filterValue: function() {
...
function(a, b) {
    ...
    c.prototype = new d({
        ...
        _initConfig: function() {
            ...
            this._hasInserting && this.modeSwitchButton && (this._grid.inserting = !1),
        ...
        itemTemplate: function(a, c) {
            var d = b([]);
            return this.editButton && (d = d.add(this._createEditButton(c))),
        ...
        _createOnOffSwitchButton: function(a, c, d) {
            ...
            this),
            g = this._createGridButton(this.modeButtonClass + " " + c, "",
            function(b) {
                e = !e,
                b.option(a, e),
                f()
        ...
        _createModeSwitchButton: function() {
            ...
            this),
            d = this._createGridButton(this.modeButtonClass, "",
            function(b) {
                a = !a,
                b.option("inserting", a),
                b.option("filtering", !a),
                c()
            });
            return c(),
            d
        ...
        _createEditButton: function(a) {
            return this._createGridButton(this.editButtonClass, this.editButtonTooltip,
            function(b, c) {
                b.editItem(a),
                c.stopPropagation()
            })
        ...
        _createDeleteButton: function(a) {
            return this._createGridButton(this.deleteButtonClass, this.deleteButtonTooltip,
            function(b, c) {
                b.deleteItem(a),
                c.stopPropagation()
            })
        ...
        _createSearchButton: function() {
            return this._createGridButton(this.searchButtonClass, this.searchButtonTooltip,
            function(a) {
                a.search()
            })
        },
        _createClearFilterButton: function() {
            return this._createGridButton(this.clearFilterButtonClass, this.clearFilterButtonTooltip,
            function(a) {
                a.clearFilter()
            })
        },
        _createInsertButton: function() {
            return this._createGridButton(this.insertButtonClass, this.insertButtonTooltip,
            function(a) {
                a.insertItem(),
                a.clearInsert()
            })
        ...
        _createUpdateButton: function() {
            return this._createGridButton(this.updateButtonClass, this.updateButtonTooltip,
            function(a, b) {
                a.updateItem(),
                b.stopPropagation()
            })
